    ...
    public partial class RecoverPassword : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request["email"] != null && Request["email"] != "") {
                ...
                sql = "SELECT * FROM dbo.customers WHERE email LIKE '" + Request["email"] + "'";
                ...
                if (rec.HasRows) { //email is in the database
                    ...
                    sql = "UPDATE dbo.customers SET password = '" + ProjectTools.CalculateMD5Hash(newPassword) + "' WHERE customer_id = '" + rec["customer_id"] + "'";
                    db.ProcessData(sql);
                    ...
                    message = "<html>\n" + "<head><title>Password Recovery</title></head>\n" +
                                ...
                                "<p><b>" + newPassword + "</b></p>\n" +
                                "<p>Please, go to <a href='https://resthubwebapp.azurewebsites.net/customers/login.aspx'>resthubwebapp.azurewebsites.net/customers/login.aspx</a> to login.</p>\n" +
